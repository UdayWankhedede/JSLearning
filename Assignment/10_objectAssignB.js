...
console.log(`Bank Name is ${sbiClone.bankName} located at ${sbiClone.branch} state ${sbiClone.state} having branch code ${sbiClone.branchCode}`);
let locationClone = Object.assign({},bankLocation);
console.log(`Bank SBI is located near ${locationClone.street} at ${locationClone.city} taluka having pin code ${locationClone.pincode}`);
...
console.log(`Bank Name is ${sbiClone.bankName} located at ${sbiClone.branch} state ${sbiClone.state} having branch code ${sbiClone.branchCode} Bank SBI is located near ${locationClone.street} at ${locationClone.city} taluka having pin code ${locationClone.pincode}\nhaving rate of interest \nHome Loan :${sbiDetails.homeLoadInterest}\nDue Loan :${sbiDetails.dueLoadInterest}\nPersonal Loan :${sbiDetails.personalLoadInterest}`);
